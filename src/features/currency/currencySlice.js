...
import { fetchAllCurrencies } from './currencyApi'
...
export const getCurrenciesAsync = createAsyncThunk('currency/fetchCurrencies', async () => {
...
export const selectCurrencies = (state) => state.currency.value
